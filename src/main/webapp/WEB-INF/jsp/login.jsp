				...
				<div class="box-content">
					<form id="loginForm" class="loginbox" name="loginForm"
						...
						<div class="form-group">
							<label class="control-label">Tên đăng nhập </label> <input type="text"
						...
						<div class="text-right">
							<a href="sign-up" class="txt-default">Tạo tài khoản?</a>
						</div>
						<div class="text-center">
						 	<c:if test="${not empty param.authfailed}">
								<div class="error txtcenter" style="margin-bottom: 8px">
								<p style="color:red;">	Email hoặc Mật khẩu không phù hợp !</p></div>
