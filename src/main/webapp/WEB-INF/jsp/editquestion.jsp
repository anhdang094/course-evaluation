					...
					<div class="panel panel-default" id="firstLink2">
						...
						<form class="form-horizontal" action="" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input class="form-control" type="number" name="levelq" min="1" max="5" value="${editQuestion.levelq}"/>
								</div>
							</div>
						...
						<%-- 	<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input class="form-control" type="hidden" name="chapterSubjectsId" value="${editQuestion.chapterSubjectsId}"/>
									...
									<input class="form-control" type="hidden" name="questionblockId" value="${editQuestion.questionblockId}"/>
							
									<input class="form-control" type="hidden" name="qUsernameId" value="${editQuestion.qUsernameId}"/>
								
									<input class="form-control" type="hidden" name="chapterId" value="${editQuestion.chapterId}"/>
